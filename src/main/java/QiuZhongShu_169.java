...
public class QiuZhongShu_169 {
    ...
    //解法四 摩尔投票
    //此题的意思可以抽象成，每种数字可以代表一个国家，各种数字出现的个数代表着各个国家的兵力值,且每一国的单兵战斗力都相同(即一个2和一个1的战斗力是相同的)
    //因此可分为干个小国，和一个大国(大国的兵力最强大 并超过其他国总和 )
    //想要得到谁是大国这个答案，可以让众国无差别进行火拼(任意两个国家的单个兵力火拼后会湮灭)，火拼结束后，必定只会留下大国的兵力
    //因为大国兵力比其他国加起来还多，即使其他小国都只与大国进行火拼，最终剩下的也只会是大国的兵力。如果其他小国之间也互相进行火拼，那大国只会笑出声
    //并且这样计算的时间复杂度也只有O(n)哦
